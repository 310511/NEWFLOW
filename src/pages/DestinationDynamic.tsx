...
const DestinationDynamic = () => {
  ...
  const destinationsData = [
    {
      ...
      description: "The capital city with modern architecture and rich culture. Explore the bustling metropolis where tradition meets innovation.",
      properties: "500+ properties",
      highlights: ["King Abdulaziz Historical Center", "Diriyah", "Kingdom Centre"],
      hotels: [
        {
          id: "1",
    ...
    },
    {
      ...
      description: "Gateway to Mecca with beautiful Red Sea coastline. Experience the historic charm and vibrant culture of this coastal gem.",
    ...
    },
    {
      ...
      description: "World-class luxury destination with iconic architecture. Discover the perfect blend of tradition and futuristic innovation.",
    ...
    },
    {
      ...
      description: "UAE's capital with cultural landmarks and luxury resorts. Immerse yourself in the rich heritage and modern marvels.",
    ...
    },
    {
      ...
      description: "Qatar's modern capital with stunning skyline and culture. Experience the perfect fusion of Arabian heritage and contemporary luxury.",
    ...
    },
    {
      id: 6,
      name: "Kuwait City",
      image: "https://images.unsplash.com/photo-1591604129277-59e94d0f9fa6?w=800&h=600&fit=crop",
      description: "Historic trading hub with modern amenities. Explore the rich history and vibrant culture of this Gulf pearl.",
    ...
    },
    {
      ...
      description: "Islam's holiest city and pilgrimage destination. Experience the spiritual heart of the Islamic world.",
      ...
      hotels: [
        {
          ...
          price: 800,
          rating: 4.8,
          image: "https://images.unsplash.com/photo-1580192225370-ad0c5b6f5ebc?w=800&h=600&fit=crop",
    ...
    },
    {
      ...
      name: "Medina",
      image: "https://images.unsplash.com/photo-1580192225370-ad0c5b6f5ebc?w=800&h=600&fit=crop", 
      description: "The Prophet's city with profound Islamic heritage. Connect with the sacred history and peaceful atmosphere.",
    ...
    },
    {
      ...
      name: "Dammam",
      image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&h=600&fit=crop",
      description: "Eastern province hub with coastal attractions. Discover the industrial heart with beautiful coastal scenery.",
    ...
    },
    {
      ...
      name: "Taif",
      image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=800&h=600&fit=crop",
      description: "Mountain resort known for roses and cool climate. Escape to the refreshing highlands and fragrant rose gardens.",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="w-full px-6 lg:px-8 py-12 pt-header-plus-20" style={{ paddingTop: 'calc(var(--header-height-default) + 20px + 9px)' }}>
        {/* Back Navigation */}
        <div className="mb-8">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-8">Popular Attractions</h2>
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold text-foreground">Hotels in {currentDestination.name}</h2>
        ...
        <div className="text-center bg-muted/50 rounded-2xl p-12">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Book your perfect stay and start creating unforgettable memories in this amazing destination.
          </p>
          <Link to="/search" state={{ destination: currentDestination.name }}>
