...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="relative pt-header-home-plus-40">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <Link key={index} to={category.link}>
                  <Card className="overflow-hidden shadow-intense-3d hover:shadow-[0_20px_50px_rgba(0,0,0,0.3),0_10px_25px_rgba(0,0,0,0.2),0_5px_15px_rgba(0,0,0,0.1)] transition-all duration-300 cursor-pointer rounded-2xl group hover:scale-[1.02]">
          ...
          <div className="w-full max-w-none px-6 lg:px-12 xl:px-16">
            <div className="flex items-center justify-between mb-12">
              <div>
                ...
                <p className="text-muted-foreground">Hand-picked accommodations for your perfect stay</p>
              </div>
              <Link to="/search">
        ...
        <section className="py-10">
          <div className="w-full max-w-none px-6 lg:px-12 xl:px-16">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-2">Luxury Hotels</h2>
                <p className="text-muted-foreground">Experience the finest hospitality</p>
              </div>
              <Link to="/search">
                <Button variant="outline" className="hidden sm:flex">
                  View all luxury
        ...
        <section className="py-10 bg-muted/30">
          <div className="w-full max-w-none px-6 lg:px-12 xl:px-16">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-2">Business Hotels</h2>
                <p className="text-muted-foreground">Perfect for business travelers</p>
              </div>
              <Link to="/search">
                <Button variant="outline" className="hidden sm:flex">
                  View all business
        ...
        <section className="py-10">
          <div className="w-full max-w-none px-6 lg:px-12 xl:px-16">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-2">Weekend Getaways</h2>
                <p className="text-muted-foreground">Perfect escapes for short trips</p>
              </div>
              <Link to="/search">
                <Button variant="outline" className="hidden sm:flex">
                  View all getaways
        ...
        <section className="py-10 bg-muted/30">
          <div className="w-full max-w-none px-6 lg:px-12 xl:px-16">
            <div className="flex items-center justify-between mb-12">
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-2">Family-Friendly Hotels</h2>
                <p className="text-muted-foreground">Great accommodations for the whole family</p>
              </div>
              <Link to="/search">
                <Button variant="outline" className="hidden sm:flex">
