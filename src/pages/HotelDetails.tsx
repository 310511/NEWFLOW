...
import { Star, Heart, Share, MapPin, Wifi, Car, Coffee, Users, Calendar, ArrowLeft, Waves, Dumbbell, UtensilsCrossed, Shield, AirVent, Tv, Bath, Bed, Shirt } from "lucide-react";
...
const HotelDetails = () => {
  ...
  const getAmenityIcon = (amenity: string) => {
    switch (amenity.toLowerCase()) {
      ...
      case 'spa': return <Bath className="h-4 w-4" />;
      case 'ac': 
      case 'air conditioning': return <AirVent className="h-4 w-4" />;
      case 'kitchen': return <UtensilsCrossed className="h-4 w-4" />;
      case 'tv': return <Tv className="h-4 w-4" />;
      case 'concierge': return <Users className="h-4 w-4" />;
      case 'workspace': return <Bed className="h-4 w-4" />;
      case 'laundry': return <Shirt className="h-4 w-4" />;
      case 'security': 
      case '24/7 support': return <Shield className="h-4 w-4" />;
      ...
      <main className="w-full px-6 lg:px-8 py-8 pt-header-plus-25" style={{ paddingTop: 'calc(var(--header-height-default) + 25px + 19px)' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-6">
            ...
            {/* Amenities */}
            <div>
              <h3 className="font-semibold text-foreground mb-4">What this place offers</h3>
              <div className="flex flex-wrap gap-3">
                {hotel.amenities.map((amenity) => (
                  <div key={amenity} className="flex items-center space-x-2 py-1 px-2 rounded-full bg-muted/50">
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <h3 className="font-semibold text-foreground mb-4">About this place</h3>
            <p className="text-muted-foreground leading-relaxed">
              ...
              With a {hotel.rating}-star rating from {hotel.reviews} guests, you can trust in the quality of your accommodation.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <h3 className="font-semibold text-foreground mb-4">Where you'll be</h3>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <span className="text-xl font-semibold">{hotel.rating} · {hotel.reviews} reviews</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Excellent location and service. The staff was very helpful and the room was clean and comfortable.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Amazing experience! The hotel exceeded my expectations in every way. Highly recommended.
                  </p>
                </div>
              </div>
            </div>
