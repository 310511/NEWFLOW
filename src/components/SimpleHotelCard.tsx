...
const SimpleHotelCard = ({ 
  ...
  return (
    <Link to={`/hotel/${hotel.id}`} className="block">
      <Card 
        className={`group cursor-pointer transition-all duration-300 shadow-intense-3d hover:shadow-[0_20px_50px_rgba(0,0,0,0.3),0_10px_25px_rgba(0,0,0,0.2),0_5px_15px_rgba(0,0,0,0.1)] border-0 bg-white overflow-hidden rounded-2xl hover:scale-[1.05] hover:-translate-y-2 ${className}`}
